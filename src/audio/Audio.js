// Inspired by https://r.osey.me/code/audio/
        ...
        return (
            <div ref={(div) => {
                ...
                <div className="audio-player-image">
                    <span className="audio-player-song-name">
                    </span>
                </div>

                <div className="audio-player-controls">
                    <span className="audio-player-progress">
                      <span className="audio-player-progress-bar">
                      </span>
                    </span>
                    <span className="audio-player-button-wrappers">
                      <a role="button" className="audio-player-button small icon-backward">
                      </a>
                      <a role="button" className="audio-player-button audio-player-place-pause-button icon-play">
                      </a>
                      <a role="button" className="audio-player-button small icon-forward">
                      </a>
                    </span>
                </div>
            </div>
